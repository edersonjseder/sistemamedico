...
<title>Sistema Médico - Cadastro Tratamentos</title> 
</head>
    ...
    <div id="content" class="content">
		...
		<div id="content_body" class="content_body">
		 	<div id="sidebar" class="sidebar">
				...
				<div id="sidebar_body" class="sidebar_body"><p><span><h:outputText value="#{msg.label_lateral_cadastro_tratamento}" styleClass="estilo_texto_label_lateral"/></span></p></div>
            ...
            <div id="text" class="text">
				...
				<div id="text_body_cadastro_tratamento" class="text_body_cadastro_tratamento">
					<h:panelGrid border="0" columns="3">
						<h:panelGroup>
							<h:outputText value="#{msg.tratamento_cadastro_tratamento}" styleClass="estilo_texto_label"/>
							<h:inputText id="tratamento" size="35" maxlength="90" value="#{controleTratamento.tratamentos.tratamento}" styleClass="estilo_texto"/>
						</h:panelGroup>
						
						<h:panelGroup>
							<h:outputText value="#{msg.descricao_cadastro_tratamento}" styleClass="estilo_texto_label"/>
							<h:inputText id="descricao" size="55" maxlength="140" value="#{controleTratamento.tratamentos.descricao}" styleClass="estilo_texto"/>
						</h:panelGroup>
						
						<a4j:commandLink styleClass="botaoCadastroTratamentos" value="#{msg.botao_cadastro_tratamento}" action="#{controleTratamento.inserirTratamento}"/>
					</h:panelGrid>
				</div>
