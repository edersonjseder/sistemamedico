...
<title>Sistema Médico - Alteração Pacientes</title> 
    ...
    <div id="content" class="content">
		...
		<div id="content_body" class="content_body">
		 	<div id="sidebar" class="sidebar">
				...
				<div id="sidebar_body" class="sidebar_body"><p><span><h:outputText value="#{msg.label_lateral_alteracao_pacientes}" styleClass="estilo_texto_label_lateral"/></span></p></div>
            ...
            <div id="text" class="text">
				...
				<div id="text_body_cadastro_paciente" class="text_body_cadastro_paciente">
					<h:panelGrid border="0" columns="3">
						<h:panelGroup>
							<h:outputText value="#{msg.nome_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							<h:inputText id="nome" size="53" maxlength="60" styleClass="estilo_texto" value="#{controlePacientes.paciente.nomePaciente}"/>
						</h:panelGroup>
						<h:panelGroup>
							<h:panelGroup>
								<h:outputText value="#{msg.rg_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							...
							<h:panelGroup>
								<h:outputText value="#{msg.cpf_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							...
							<h:panelGroup>
								<h:outputText value="#{msg.sexo_alteracao_medico}" styleClass="estilo_texto_label"/>
						...
						<h:panelGroup>
							<h:outputText value="#{msg.nasc_alteracao_pacientes}" styleClass="estilo_texto_label"/>
					...
					<h:panelGrid border="0" columns="2">
						<h:panelGroup>
							<h:outputText value="#{msg.endereco_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							<h:inputText id="endereco" size="74" maxlength="80" styleClass="estilo_texto" value="#{controlePacientes.paciente.enderecoPaciente}"/>
						</h:panelGroup>
						<h:panelGroup>
							<h:panelGroup>
								<h:outputText value="#{msg.bairro_alteracao_pacientes}" styleClass="estilo_texto_label"/>
								<h:inputText id="bairro" size="31" maxlength="40" styleClass="estilo_texto" value="#{controlePacientes.paciente.bairroPaciente}"/>
							</h:panelGroup>
							<h:panelGroup>
								<h:outputText value="#{msg.cep_alteracao_pacientes}" styleClass="estilo_texto_label"/>
					...
					<h:panelGrid border="0" columns="3">
						<h:panelGroup>
							<h:outputText value="#{msg.cidade_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							<h:inputText id="cidade" size="42" maxlength="90" styleClass="estilo_texto" value="#{controlePacientes.paciente.cidadePaciente}"/>
						</h:panelGroup>
						
						<h:panelGroup>
							<h:panelGroup>
								<h:outputText value="#{msg.estado_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							...
							<h:panelGroup>
								<h:outputText value="#{msg.uf_alteracao_pacientes}" styleClass="estilo_texto_label"/>
						...
						<h:panelGroup>
							<h:panelGroup>
								<h:outputText value="#{msg.fone_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							...
							<f:verbatim>&nbsp;</f:verbatim>
							<h:panelGroup>
								<h:outputText value="#{msg.celular_alteracao_pacientes}" styleClass="estilo_texto_label"/>
						...
						<h:panelGroup>
							<h:outputText value="#{msg.mae_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							<h:inputText id="mae" size="44" maxlength="90" styleClass="estilo_texto" value="#{controlePacientes.paciente.nomeMae}"/>
						</h:panelGroup>
						
						<h:panelGroup>
							<h:outputText value="#{msg.pai_alteracao_pacientes}" styleClass="estilo_texto_label"/>
							<h:inputText id="pai" size="35" maxlength="90" styleClass="estilo_texto" value="#{controlePacientes.paciente.nomePai}"/>
						</h:panelGroup>
						
						<a4j:commandLink styleClass="botaoCadastroPacientes" value="#{msg.botao_alteracao_medico}" action="#{controlePacientes.inserirPaciente}"/>
					</h:panelGrid>
				</div>
