...
<title>Sistema Médico - Cadastro Medicamentos</title> 
</head>
    ...
    <div id="content" class="content">
		...
		<div id="content_body" class="content_body">
		 	<div id="sidebar" class="sidebar">
				...
				<div id="sidebar_body" class="sidebar_body"><p><span><h:outputText value="#{msg.label_lateral_cadastro_medicamento}" styleClass="estilo_texto_label_lateral"/></span></p></div>
            ...
            <div id="text" class="text">
				...
				<div id="text_body_cadastro" class="text_body_cadastro">
					<h:panelGrid border="0" columns="3">
						<h:panelGroup>
							<h:outputText value="#{msg.nome_cadastro_medicamento}" styleClass="estilo_texto_label"/>
							<h:inputText id="medicamento" size="25" maxlength="60" value="#{controleMedicamentos.medicamentos.nomeMedicamento}" styleClass="estilo_texto"/>
						</h:panelGroup>
						
						<h:panelGroup>
							<h:outputText value="#{msg.data_validade_cadastro_medicamento}" styleClass="estilo_texto_label"/>
						...
						<h:panelGroup>
							<h:outputText value="#{msg.descricao_cadastro_medicamento}" styleClass="estilo_texto_label"/>
							<h:inputText id="descricao" size="40" maxlength="50" value="#{controleMedicamentos.medicamentos.descricao}" styleClass="estilo_texto"/>
						</h:panelGroup>
						...
						<a4j:commandLink styleClass="botaoCadastroMedicamentos" value="#{msg.botao_cadastro_medicamento}" action="#{controleMedicamentos.inserirMedicamento}"/>
					</h:panelGrid>
				</div>
