...
<title>Sistema Médico - Cadastro Médicos</title> 
</head>
    ...
    <div id="content" class="content">
		...
		<div id="content_body" class="content_body">
		 	<div id="sidebar" class="sidebar">
				...
				<div id="sidebar_body" class="sidebar_body"><p><span><h:outputText value="#{msg.label_lateral_cadastro_medico}" styleClass="estilo_texto_label_lateral"/></span></p></div>
            ...
            <div id="text" class="text">
				...
				<div id="text_body_cadastro" class="text_body_cadastro">
					<h:panelGrid border="0" columns="3">
						...
						<a4j:commandLink styleClass="botaoCadastro" value="#{msg.botao_cadastro_medico}" action="#{controleMedicos.inserirMedico}" reRender="painel" oncomplete="#{controleMedicos.showModalPanel}"/>
					</h:panelGrid>
				</div>
