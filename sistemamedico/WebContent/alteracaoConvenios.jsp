...
<title>Sistema Médico - Alteração Convênios</title> 
</head>
    ...
    <div id="content" class="content">
		...
		<div id="content_body" class="content_body">
		 	<div id="sidebar" class="sidebar">
				...
				<div id="sidebar_body" class="sidebar_body"><p><span><h:outputText value="#{msg.label_lateral_alteracao_convenio}" styleClass="estilo_texto_label_lateral"/></span></p></div>
            ...
            <div id="text" class="text">
				...
				<div id="text_body_cadastro_convenio" class="text_body_cadastro_convenio">
					<h:panelGrid border="0" columns="3">
						<h:panelGroup>
							<h:outputText value="#{msg.nome_alteracao_convenio}" styleClass="estilo_texto_label"/>
							<h:inputText id="convenio" size="25" maxlength="60" value="#{controleConvenios.convenio.nomeConvenio}" styleClass="estilo_texto"/>
						</h:panelGroup>
						
						<h:panelGroup>
							<h:outputText value="#{msg.site_alteracao_convenio}" styleClass="estilo_texto_label"/>
							<h:inputText id="site" size="20" maxlength="50" value="#{controleConvenios.convenio.siteConvenio}" styleClass="estilo_texto"/>
						</h:panelGroup>
						
						<h:panelGroup>
							<h:outputText value="#{msg.descricao_alteracao_convenio}" styleClass="estilo_texto_label"/>
							<h:inputText id="descricao" size="60" maxlength="90" value="#{controleConvenios.convenio.descricaoConvenio}" styleClass="estilo_texto"/>
						</h:panelGroup>
						...
						<a4j:commandLink styleClass="botaoCadastroConvenio" value="#{msg.botao_alteracao_convenio}" action="#{controleConvenios.inserirConvenio}"/>
					</h:panelGrid>
				</div>
