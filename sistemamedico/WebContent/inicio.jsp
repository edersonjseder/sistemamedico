...
<title>Sistema de Medicina</title>
</head>
<body>
<f:view>
	<h:form>
	    ...
	    <div id="content" class="content">
			...
			<div id="content_body" class="content_body">
	            ...
	            <div id="text" class="text">
					...
					<div id="text_body_inicio" class="text_body_inicio">
						<h:panelGrid columns="2" border="0">
							<h:commandLink action="#{controle.entrarAdministrador}" styleClass="botao" value="Administrador"/>
							<h:commandLink action="#{controle.entrarUsuario}" styleClass="botao" value="Usuário"/>
						</h:panelGrid>
					</div>
